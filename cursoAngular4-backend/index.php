...
$app->get("/probando", function() use($app){
	echo "Hola mundo desde probando Slim php";
});
...
//Metodo para devolver SOLO un producto
...
//Metodo para GUARDAR productos en la BD
...
//Si insert da true, lo devuelve (no hay error)
	if($insert){
		$result = array(
			'status' => 'success',
			'code' => 200,
